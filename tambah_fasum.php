        ...
        <main>
            <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        <li>
                            <a href="fasilitas_umum.php">Fasum</a>
                        </li>
                        <li><i class='bx bx-chevron-right'></i></li>
                        <li>
                            <a class="active" href="#">Tambah Fasum</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <!-- form tambah kamar  -->
            <form action="cek_tambah_fasum.php" method="POST" class="form" enctype="multipart/form-data">

                <div class="input-box">
                    <label for="nomor">Nama Kamar</label>
                    <input type="hidden" name="tanggal" value="<?= $tgl; ?>">
                    <input type="text" placeholder="Nama Fasum" name="nama_fasum" id="nomor" required />
                </div>
